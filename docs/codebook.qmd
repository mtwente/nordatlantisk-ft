...
::: {.callout-note}
As of July 2025, I am migrating this repository to [Quarto](https://www.quarto.org). This page has not been updated yet and may not reflect the current state of teh data set.
:::


## Introduction {#introduction}

This codebook provides descriptions of the `nordatlantisk-ft` data set, i.e. of all files in [`../data/`](../data). Variables are described for each file individually with information on connections to other variables within the pipeline to create the data set. All data, unless otherwise specified, is retrieved from the records of the parliament of Denmark, @folketingetFolketingetsAbneData2024.
...
See @ackrenPoliticalPartiesGreenland2015 for an analysis of the development of Greenlandic political parties until 2014. For overviews of the Faroese political party system see @westSkipanarligarFortreytirOg2022 in Faroese and @westFaeroskPolitikMellem2020 in Danish. @harderSupplerendeMaterialeFaeroske2022 provides a list of all Greenlandic and Faroese MPs and their party association(s) going back until 1953.
