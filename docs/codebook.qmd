...
The general structure of the data set and the files used in the workflow to compile the final `northatlantisk_ft` output is illustrated in @fig-datamodel.
